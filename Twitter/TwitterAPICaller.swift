...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "gw0icqfZQPNgKbJAEHalEyKyd", consumerSecret: "IKEjc1M5jMiRcN0f58grNCVq8Ts2hLdS6DQOdABgjQftdZyYZx")
    var loginSuccess: (() -> ())?
